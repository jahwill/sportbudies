...
class TextStyles {
  ...
  static TextStyle get t1 => openSans.regular.size(FontSizes.s16);

  static TextStyle get t2 => openSans.semiBold.size(FontSizes.s14);

  static TextStyle get h1 => openSans.bold.size(FontSizes.s96);

  static TextStyle get h2 => openSans.bold.size(FontSizes.s60);

  static TextStyle get h3 => openSans.bold.size(FontSizes.s48);

  static TextStyle get h4 => openSans.bold.size(FontSizes.s34);

  static TextStyle get h5 => openSans.bold.size(FontSizes.s24);

  static TextStyle get h6 => openSans.semiBold.size(FontSizes.s20);

  static TextStyle get h7 => openSans.semiBold.size(FontSizes.s18);

  static TextStyle get body1 => openSans.regular.size(FontSizes.s18);

  static TextStyle get body2 => openSans.regular.size(FontSizes.s14);

  static TextStyle get body3 => openSans.size(FontSizes.s12);

  static TextStyle get footnote => openSans.regular.size(FontSizes.s10);

  static TextStyle get caption => openSans.regular.size(FontSizes.s12);

  static TextStyle get button => openSans.light.size(FontSizes.s18);

  static TextStyle get robotoCustom =>
      GoogleFonts.roboto().light.size(FontSizes.s12);
}
